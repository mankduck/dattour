<div class="ibox">
    <div class="ibox-title">
        <div class="uk-flex uk-flex-middle uk-flex-space-between">
            <h5>Album ảnh</h5>
            <div class="upload-album"><a href="" class="upload-picture">Thêm danh sách ảnh </a></div>
        </div>
    </div>
    <div class="ibox-content">
        @php
            $album = (isset($destination->album) && is_array($destination->album)) ? $destination->album : [];
            ...
            <div class="col-lg-12">
                @if (!isset($gallery) || count($gallery) == 0)
                    <div class="click-to-upload">
                        ...
                        <div class="small-text">Click vào đây để thêm ảnh</div>
                    </div>
                @endif
