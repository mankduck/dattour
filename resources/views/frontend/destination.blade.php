                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-sm-6">
                        <a href="destination-details.html" class="destination-banner h-calc">
                            <img src="/frontend/images/destination/destination-7.png" alt="travello">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="destination-details.html" class="destination-banner h-calc">
                            <img src="/frontend/images/destination/destination-8.png" alt="travello">
                            <div class="destination-content">
                                <div class="ratting-badge">
                                    <i class="ri-star-s-fill"></i>
                                    <span>4.5</span>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a href="destination-details.html" class="destination-banner h-calc">
                            <img src="/frontend/images/destination/destination-6.png" alt="travello">
                            <div class="destination-content">
                                <div class="ratting-badge">
                                    <i class="ri-star-s-fill"></i>
                                    <span>4.5</span>
                    ...
                    <div class="col-lg-8 col-sm-6">
                        <a href="destination-details.html" class="destination-banner h-calc">
                            <img src="/frontend/images/destination/destination-9.png" alt="travello">
                            <div class="destination-content">
                                <div class="ratting-badge">
                                    <i class="ri-star-s-fill"></i>
                                    <span>4.5</span>
                    ...
                    <div class="col-lg-5 col-sm-6">
                        <a href="destination-details.html" class="destination-banner h-calc">
                            <img src="/frontend/images/destination/destination-2.png" alt="travello">
                            <div class="destination-content">
                                <div class="ratting-badge">
                                    <i class="ri-star-s-fill"></i>
                                    <span>4.5</span>
