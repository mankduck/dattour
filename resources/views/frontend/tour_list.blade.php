...
@section('clientContent')
    ...
    @include('frontend.component.breadcrumb', ['title' => config('apps.menus.menu.tours')])
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-6">
                                    <div class="package-card">
                                        ...
                                        <div class="package-content">
                                            <h4 class="area-name">
                                                <a
                                                    href="{{ route('frontend.tour.detail', ['category' => $tourCategory->slug, 'slug' => $tour->slug]) }}">{{ $tour->name }}</a>
                                            </h4>
                                            <div class="location">
                                                <i class="ri-map-pin-line"></i>
                                                <div class="name tour-name">{{ $tour->destination->name }}</div>
                                            </div>
